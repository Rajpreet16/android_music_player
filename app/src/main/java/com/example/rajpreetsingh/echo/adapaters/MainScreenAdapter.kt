...
class MainScreenAdapter(_songDetails: ArrayList<Songs>, _context: Context) : RecyclerView.Adapter<MainScreenAdapter.MyViewHolder>() {
    var songDetails: ArrayList<Songs> = _songDetails
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        * trackArtist for holding the name of the artist*/
        ...
        holder.contentHolder?.setOnClickListener({
            ...
            val song_playing_fragment = SongPlayingFragment()
            var args = Bundle()
            ...
            song_playing_fragment.arguments = args

            (mContext as FragmentActivity).supportFragmentManager
                    .beginTransaction()
                    .replace(R.id.details_fragment, song_playing_fragment)
